...
var insertToQueue = function insertToQueue(context) {
    return function (running) {
        return function (resolve, reject) {
            ...
            var insertParam = [running.tag, running.queue_uuid, running.key, running.utc_run, running.run_script, running.params, running.priority, running.retry, moment.utc().format("YYYY-MM-DDTHH:mm:ss")];
