...
var queueRetrieve = function (_a) {
    var openDb = _a.openDb, tableName = _a.tableName, runningTableName = _a.runningTableName, tag = _a.tag, log = _a.log, logLevel = _a.logLevel, retry = _a.retry;
    return function (jobUuid) { return function (resolve, reject) {
