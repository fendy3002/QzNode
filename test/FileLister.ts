...
mocha.describe('FileLister', function() {
    mocha.describe('Listing', function(done) {
        mocha.it('should list file', function(done) {
        ...
        mocha.it('should output list file', function(done) {
            let readPath = path.join(__dirname, "..", "testHelper", "fileToList");
        ...
        mocha.it('should output log file', function(done) {
            let readPath = path.join(__dirname, "..", "testHelper", "fileToList");
