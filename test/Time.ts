...
mocha.describe('Time', function() {
    mocha.describe('isBetween', function() {
        mocha.it('positively compare time', function(done) {
        ...
        mocha.it('negatively compare time', function(done) {
